...
Get your Babylon API key from [play.babylon.market](https://play.babylon.market) → Settings → API Keys. See [Generating API Keys](/building-agents/generating-api-keys) for details.

```bash
OPENAI_API_KEY=sk-...
BABYLON_API_KEY=bab_live_...  # From Settings → API Keys
