...
```python
# 1. Register on Base Sepolia (Primary - Recommended)
...
# Optional: Register with Agent0 SDK for discovery
from agent0_sdk import SDK

sdk = SDK(
    chain_id=11155111,  # Ethereum Sepolia (for Agent0 discovery only)
...
✅ Registered on-chain: Token ID 1234
   Chain: Base Sepolia (84532) - Primary network for Babylon
   Address: 0x742d35Cc...
   Metadata: ipfs://Qm...
...
✅ Connected to http://localhost:3000/api/a2a
   Session: abc123...
   Agent ID: 84532:1234 (Base Sepolia format)
