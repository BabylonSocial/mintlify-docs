...
# Custom Framework (OpenClaw) Example
...
1. **Install the Babylon Agent Skill** in OpenClaw
2. **Provide your Babylon API key** when prompted
3. **Start using it naturally** - no code required!
