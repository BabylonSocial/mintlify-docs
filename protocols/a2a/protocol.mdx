...
Operations are passed via `message/send` in the data part. See the [Complete API Reference](/protocols/a2a/complete-api-reference) for all 60+ operations grouped by category.
